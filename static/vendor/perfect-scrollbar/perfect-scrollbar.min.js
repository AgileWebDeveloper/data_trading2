...
!(function(t, e) {
    ...
    function e(t, e) {
        for (const i in e) {
            let n = e[i];
            typeof n === 'number' && (n += 'px'), (t.style[i] = n);
        }
        return t;
    }
    function i(t) {
    ...
    function l(t, e) {
        return Array.prototype.filter.call(t.children, (t) => n(t, e));
    }
    function o(t, e) {
    ...
    function s(t, e) {
        w[e] = setTimeout(() => t.element.classList.remove(m.state.scrolling(e)), t.settings.scrollingThreshold);
    }
    function a(t, e) {
        o(t, e), s(t, e);
    }
    ...
    function b(t, i) {
        const n = { width: i.railXWidth };
        i.isRtl
            ? (n.left = i.negativeScrollAdjustment + t.scrollLeft + i.containerWidth - i.contentWidth)
            : (n.left = t.scrollLeft),
        i.isScrollbarXUsingBottom
            ? (n.bottom = i.scrollbarXBottom - t.scrollTop)
            : (n.top = i.scrollbarXTop + t.scrollTop),
        e(i.scrollbarXRail, n);
        const r = { top: t.scrollTop, height: i.railYHeight };
    ...
    (Y.prototype.unbind = function(t, e) {
        const i = this;
        this.handlers[t] = this.handlers[t].filter((n) => !(!e || n === e) || (i.element.removeEventListener(t, n, !1), !1));
    }),
    ...
    (X.isEmpty.get = function() {
        const t = this;
        return Object.keys(this.handlers).every((e) => t.handlers[e].length === 0);
    }),
    ...
    var y = function(t, e, i, n) {
            void 0 === n && (n = !0);
            let r;
            if (e === 'top') r = ['contentHeight', 'containerHeight', 'scrollTop', 'y', 'up', 'down'];
            else {
        ...
        L = function(t) {
            ...
            e.contains(t.scrollbarXRail) ||
                    (l(e, m.element.rail('x')).forEach((t) => r(t)),
                    e.appendChild(t.scrollbarXRail)),
            e.contains(t.scrollbarYRail) ||
                    (l(e, m.element.rail('y')).forEach((t) => r(t)),
        ...
        H = {
            'click-rail': function(t) {
                ...
                t.event.bind(t.scrollbarYRail, 'mousedown', (i) => {
                    const n =
                            i.pageY - window.pageYOffset - t.scrollbarYRail.getBoundingClientRect().top >
                            t.scrollbarYTop
                                ? 1
                                : -1;
                ...
                t.event.bind(t.scrollbarXRail, 'mousedown', (i) => {
                    const n =
                            i.pageX - window.pageXOffset - t.scrollbarXRail.getBoundingClientRect().left >
                            t.scrollbarXLeft
                                ? 1
                                : -1;
            ...
            keyboard(t) {
                function e(e, n) {
                    ...
                    if (e === 0) {
                        ...
                        if ((r === 0 && n > 0) || (r >= t.contentHeight - t.containerHeight && n < 0))
                        {return !t.settings.wheelPropagation;}
                    }
                    const l = i.scrollLeft;
                    if (n === 0) {
                        if (!t.scrollbarXActive) return !1;
                        if ((l === 0 && e < 0) || (l >= t.contentWidth - t.containerWidth && e > 0))
                        {return !t.settings.wheelPropagation;}
                    }
                    return !0;
                }
            ...
            wheel(e) {
                function i(t, i) {
                    ...
                    if (t === 0) {
                        ...
                        if ((n === 0 && i > 0) || (n >= e.contentHeight - e.containerHeight && i < 0))
                        {return !e.settings.wheelPropagation;}
                    }
                    const r = o.scrollLeft;
                    if (i === 0) {
                        if (!e.scrollbarXActive) return !1;
                        if ((r === 0 && t < 0) || (r >= e.contentWidth - e.containerWidth && t > 0))
                        {return !e.settings.wheelPropagation;}
                    }
                    return !0;
                }
                ...
                function r(e, i, n) {
                    ...
                    for (let r = e; r && r !== o; ) {
                        ...
                        if ([l.overflow, l.overflowX, l.overflowY].join('').match(/(scroll|auto)/)) {
                            ...
                            const a = r.scrollLeft - r.clientWidth;
                            if (a > 0 && !((r.scrollLeft === 0 && i < 0) || (r.scrollLeft === a && i > 0))) return !0;
                        }
                        r = r.parentNode;
                    }
                    return !1;
            ...
            touch(t) {
                function e(e, i) {
                    let n = h.scrollTop,
                        ...
                        o = Math.abs(i);
                    if (o > l) {
                        if ((i < 0 && n === t.contentHeight - t.containerHeight) || (i > 0 && n === 0))
                        {return { stop: !t.settings.swipePropagation, prevent: window.scrollY === 0 };}
                    } else if (l > o && ((e < 0 && r === t.contentWidth - t.containerWidth) || (e > 0 && r === 0)))
        ...
        T = function(n, r) {
            const l = this;
            if ((void 0 === r && (r = {}), typeof n === 'string' && (n = document.querySelector(n)), !n || !n.nodeName))
            ...
            for (const o in r) l.settings[o] = r[o];
            ...
            this.settings.handlers.forEach((t) => H[t](l)),
            this.event.bind(this.element, 'scroll', () => L(l)),
            L(this);
        },
