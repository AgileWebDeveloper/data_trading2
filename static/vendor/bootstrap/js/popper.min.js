 ...
 */ (function(
    ...
    function r(e) {
        ...
        return i && i !== 'BODY' && i !== 'HTML'
            ? ['TD', 'TABLE'].indexOf(o.nodeName) !== -1 && t(o, 'position') === 'static'
                ? r(o)
                : o
    ...
    function g(e) {
        ...
        let r = { left: o.left, top: o.top, width: o.right - o.left, height: o.bottom - o.top },
            p = e.nodeName === 'HTML' ? h() : {},
    ...
    function w(e, t, i, r) {
        ...
        if (r === 'viewport') p = b(s);
            ...
            let a;
            r === 'scrollParent'
                ? ((a = n(o(e))), a.nodeName === 'BODY' && (a = window.document.documentElement))
                : r === 'window'
    ...
    function k() {
        if (!this.state.isDestroyed) {
            let e = { instance: this, styles: {}, attributes: {}, flipped: !1, offsets: {} };
    ...
    function U(e, t) {
        Object.keys(t).forEach((o) => {
            let i = '';
            ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(o) !== -1 && R(t[o]) && (i = 'px'),
            (e.style[o] = t[o] + i);
        });
    }
    function Y(e, t) {
    ...
    function F(e, t, o) {
        let i = T(e, (e) => {
            ...
            n =
                !!i &&
                e.some((e) => e.name === o && e.enabled && e.order < i.order);
        if (!n) {
            const r = `\`${  t  }\``;
            console.warn(
                `\`${ 
    ...
    var i,
        ...
        se =
            ...
            function(e) {
                ...
                {for (const i in ((t = arguments[o]), t)) Object.prototype.hasOwnProperty.call(t, i) && (e[i] = t[i]);}
                return e;
            },
        de = [
            'auto-start',
        ...
        le = (function() {
            function t(o, i) {
                ...
                Object.keys(se({}, t.Defaults.modifiers, r.modifiers)).forEach((e) => {
                ...
                (this.modifiers = Object.keys(this.options.modifiers)
                    .map((e) => se({ name: e }, n.options.modifiers[e]))
