    ...
    const Alert = (function($) {
        ...
        const Alert = (function() {
            ...
            Alert.prototype._removeElement = function _removeElement(element) {
                ...
                $(element)
                    .one(Util.TRANSITION_END, (event) => _this2._destroyElement(element, event))
            ...
            function ScrollSpy(element, config) {
                ...
                this._selector =
                    `${this._config.target 
                        ...
                        this._config.target  } ${  Selector.LIST_ITEMS  },${this._config.target  } ${  Selector.DROPDOWN_ITEMS}`;
                this._offsets = [];
                this._targets = [];
        ...
        const Tooltip = (function() {
            ...
            Tooltip.prototype._setListeners = function _setListeners() {
                ...
                triggers.forEach((trigger) => {
                    if (trigger === 'click') {
                        $(_this26.element).on(_this26.constructor.Event.CLICK, _this26.config.selector, (
                            event
                        ) => _this26.toggle(event));
                        ...
                        $(_this26.element)
                            .on(eventIn, _this26.config.selector, (event) => _this26._enter(event))
                            .on(eventOut, _this26.config.selector, (event) => _this26._leave(event));
                    }
