        ...
        s =
                            ...
                            return (
                                ...
                                (l.prototype._slide = function(e, n) {
                                    ...
                                    {this._isSliding = !1;}
                                        ...
                                        const m = t.Event(d.SLID, { relatedTarget: a, direction: g, from: s, to: l });
                                ...
                                (l._jQueryInterface = function(e) {
                                    return this.each(function() {
                                        ...
                                        if ((n || ((n = new l(this, o)), t(this).data(s, n)), typeof e === 'number'))
                                        {n.to(e);}
                                ...
                                (l._dataApiClickHandler = function(e) {
                                    ...
                                    if (n) {
                                        ...
                                        if (i && t(i).hasClass(f.CAROUSEL)) {
                                            let o = t.extend({}, t(i).data(), t(this).data()),
                        ...
                        g = (function() {
                            ...
                            return (
                                ...
                                (l._clearMenus = function(e) {
                                    ...
                                    {for (let n = t.makeArray(t(d.DATA_TOGGLE)), i = 0; i < n.length; i++) {
                                        let o = l._getParentFromElement(n[i]),
                                            r = t(n[i]).data(s),
                                            a = { relatedTarget: n[i] };
                                        if (r) {
                                            const h = r._menu;
                ...
                (function(t) {
                            ...
                            return (
                                ...
                                (a.prototype.show = function(e) {
                                    ...
                                    if (!this._isTransitioning) {
                                        ...
                                        this._isShown ||
                                                ...
                                                t(this._element).on(c.CLICK_DISMISS, d.DATA_DISMISS, (t) => n.hide(t)),
                                ...
                                (a.prototype.hide = function(e) {
                                    ...
                                    if ((e && e.preventDefault(), !this._isTransitioning && this._isShown)) {
                                        const i = r.supportsTransitionEnd() && t(this._element).hasClass(u.FADE);
                                ...
                                (a.prototype._showElement = function(e) {
                                    ...
                                    let o = t.Event(c.SHOWN, { relatedTarget: e }),
                                        s = function() {
                                            ...
                                            t(this._element).on(c.CLICK_DISMISS, (t) => {
                                                n._ignoreBackdropClick
                                                    ...
                                                    : t.target === t.currentTarget &&
                                                      (n._config.backdrop === 'static' ? n._element.focus() : n.hide());
                                            }),
                                ...
                                (a.prototype._setScrollbar = function() {
                                    ...
                                    if (this._isBodyOverflowing) {
                                        t(d.FIXED_CONTENT).each((n, i) => {
                                            let o = t(i)[0].style.paddingRight,
                    ...
                    t(document).on(c.CLICK_DATA_API, d.DATA_TOGGLE, function(e) {
                        ...
                        o && (i = t(o)[0]);
                        const s = t(i).data('bs.modal') ? 'toggle' : t.extend({}, t(i).data(), t(this).data());
                            ...
                            return (
                                (e.prototype.show = function() {
                                    ...
                                    if (
                                        ...
                                        let c = t.Event(i.HIDE, { relatedTarget: this._element }),
                                        ...
                                        if (
                                            ...
                                            const d = function() {
                                                let n = t.Event(i.HIDDEN, { relatedTarget: e._element }),
                        ...
                        m = (function() {
                            ...
                            return (
                                ...
                                (a.prototype.setElementContent = function(e, n) {
                                    ...
                                    (void 0 === n ? 'undefined' : i(n)) === 'object' && (n.nodeType || n.jquery)
                                        ? o
                                            ? t(n)
                                                .parent()
                                ...
                                (a.prototype._enter = function(e, n) {
                                    ...
                                    e && (n._activeTrigger[e.type === 'focusin' ? g.FOCUS : g.HOVER] = !0),
                                ...
                                (a.prototype._leave = function(e, n) {
                                    ...
                                    (n = n || t(e.currentTarget).data(i)) ||
                                        ((n = new this.constructor(e.currentTarget, this._getDelegateConfig())),
                                        t(e.currentTarget).data(i, n)),
                                    e && (n._activeTrigger[e.type === 'focusout' ? g.FOCUS : g.HOVER] = !1),
                                ...
                                (a.prototype._getConfig = function(n) {
                                    return (
                                        ...
                                        n.title && typeof n.title === 'number' && (n.title = n.title.toString()),
                                        n.content && typeof n.content === 'number' && (n.content = n.content.toString()),
                                        r.typeCheckConfig(e, n, this.constructor.DefaultType),
                                        n
                                    );
                                }),
                        ...
                        return this.each(function() {
                            ...
                            if (
                                (e || !/destroy|hide/.test(t)) &&
                                    (e || ((e = new h(this, n)), r(this).data('bs.popover', e)), typeof t === 'string')
                            ) {
