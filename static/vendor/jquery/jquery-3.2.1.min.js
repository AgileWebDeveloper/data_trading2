...
!(function(a, b) {
        ...
        isPlainObject(a) {
            ...
            return (
                !(!a || k.call(a) !== '[object Object]') &&
                    (!(b = e(a)) ||
                        ((c = l.call(b, 'constructor') && b.constructor), typeof c === 'function' && m.call(c) === n))
            );
        },
        isEmptyObject(a) {
            let b;
    ...
    const x = (function(a) {
        ...
        (m = ga.setDocument = function(a) {
            ...
            return g !== n && g.nodeType === 9 && g.documentElement
                ...
                (c.getElementsByTagName = ja((a) => a.appendChild(n.createComment('')), !a.getElementsByTagName('*').length)),
                (c.getElementsByClassName = Y.test(n.getElementsByClassName)),
                (c.getById = ja((a) => (o.appendChild(a).id = u), !n.getElementsByName || !n.getElementsByName(u).length)),
                c.getById
    ...
    r.extend({
        ...
        when(a) {
            ...
            if (
                b <= 1 &&
                (P(a, g.done(h(c)).resolve, g.reject, !b), g.state() === 'pending' || r.isFunction(e[c] && e[c].then))
            )
            {return g.then();}
    ...
    r.each(['height', 'width'], (a, b) => {
        r.cssHooks[b] = {
            ...
            set(a, c, d) {
                ...
                return (
                    g && (e = ba.exec(c)) && (e[3] || 'px') !== 'px' && ((a.style[b] = c), (c = r.css(a, b))),
                    Ya(a, c, g)
                );
            },
        };
    ...
    r.extend({
        ...
        ajax(b, c) {
            ...
            if (
                (o.data && o.processData && typeof o.data !== 'string' && (o.data = r.param(o.data, o.traditional)),
                Nb(Ib, o, c, y),
                k)
            )
            {return y;}
