    ...
    const S2 = (function() {
        ...
        S2.define('select2/results', ['jquery', './utils'], ($, Utils) => {
            ...
            Results.prototype.render = function() {
                const $results = $('<ul class="select2-results__options" role="tree"></ul>');
            ...
            Results.prototype.setClasses = function() {
                ...
                this.data.current((selected) => {
                    ...
                    const $options = self.$results.find('.select2-results__option[aria-selected]');
            ...
            Results.prototype.bind = function(container, $container) {
                ...
                container.on('results:next', () => {
                    ...
                    const currentOffset = self.$results.offset().top + self.$results.outerHeight(false);
        ...
        S2.define('select2/selection/single', ['jquery', './base', '../utils', '../keys'], (
            $,
            BaseSelection,
            Utils,
            KEYS
        ...
        S2.define('select2/selection/multiple', ['jquery', './base', '../utils'], ($, BaseSelection, Utils) => {
        ...
        S2.define('select2/selection/placeholder', ['../utils'], (Utils) => {
            ...
            Placeholder.prototype.update = function(decorated, data) {
                const singlePlaceholder = data.length == 1 && data[0].id != this.placeholder.id;
        ...
        S2.define('select2/selection/allowClear', ['jquery', '../keys'], ($, KEYS) => {
            function AllowClear() {}
            ...
            AllowClear.prototype.update = function(decorated, data) {
                ...
                const $remove = $('<span class="select2-selection__clear">' + '&times;' + '</span>');
            ...
            Search.prototype.bind = function(decorated, container, $container) {
                ...
                this.$selection.on('keydown', '.select2-search--inline', (evt) => {
                    ...
                    if (key === KEYS.BACKSPACE && self.$search.val() === '') {
                        const $previousChoice = self.$searchContainer.prev('.select2-selection__choice');
        ...
        S2.define('select2/data/array', ['./select', '../utils', 'jquery'], (SelectAdapter, Utils, $) => {
        ...
        S2.define('select2/dropdown/infiniteScroll', ['jquery'], ($) => {
            ...
            InfiniteScroll.prototype.bind = function(decorated, container, $container) {
                ...
                this.$results.on('scroll', () => {
                    const isLoadMoreVisible = $.contains(document.documentElement, self.$loadingMore[0]);
                    ...
                    const currentOffset = self.$results.offset().top + self.$results.outerHeight(false);
                    const loadingMoreOffset = self.$loadingMore.offset().top + self.$loadingMore.outerHeight(false);
            ...
            (
                ...
                Defaults.prototype.apply = function(options) {
                    ...
                    if ($.isArray(options.language)) {
                        ...
                        const baseTranslation = Translation.loadPath(`${this.defaults.amdLanguageBase  }en`);
        ...
        S2.define('select2/options', ['require', 'jquery', './defaults', './utils'], (
            require,
            $,
            Defaults,
            Utils
        ...
        S2.define('select2/core', ['jquery', './options', './utils', './keys'], ($, Options, Utils, KEYS) => {
        ...
        S2.define('select2/compat/inputData', ['jquery'], ($) => {
            ...
            InputData.prototype.current = function(_, callback) {
                function getSelected(data, selectedIds) {
                    ...
                    if (data.children) {
                        selected.push(...getSelected(data.children, selectedIds));
                    }
                ...
                for (let d = 0; d < this._currentData.length; d++) {
                    ...
                    selected.push(...getSelected(data, this.$element.val().split(this._valueSeparator)));
                }
        ...
        S2.define('jquery.select2', ['jquery', 'jquery-mousewheel', './select2/core', './select2/defaults'], (
            $,
            _,
            Select2,
            Defaults
